...
func (_c *Subscriber_Close_Call) Return(_a0 error) *Subscriber_Close_Call {
	_c.Call.Return(_a0)
	return _c
}
...
func (_c *Subscriber_Subscribe_Call) RunAndReturn(run func(context.Context, events.SubscriberConfig) error) *Subscriber_Subscribe_Call {
	_c.Call.Return(run)
	return _c
}
