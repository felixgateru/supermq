...
func (_c *Authorization_Authorize_Call) Return(_a0 error) *Authorization_Authorize_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *Authorization_Authorize_Call) RunAndReturn(run func(context.Context, authz.PolicyReq) error) *Authorization_Authorize_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_c *Authorization_AuthorizePAT_Call) Return(_a0 error) *Authorization_AuthorizePAT_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *Authorization_AuthorizePAT_Call) RunAndReturn(run func(context.Context, authz.PatReq) error) *Authorization_AuthorizePAT_Call {
	_c.Call.Return(run)
	return _c
}
