...
func (_c *Provisioner_AddNewEntitiesRoles_Call) Return(_a0 []roles.RoleProvision, _a1 error) *Provisioner_AddNewEntitiesRoles_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *Provisioner_AddNewEntitiesRoles_Call) RunAndReturn(run func(context.Context, string, string, []string, []policies.Policy, map[roles.BuiltInRoleName][]roles.Member) ([]roles.RoleProvision, error)) *Provisioner_AddNewEntitiesRoles_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_c *Provisioner_RemoveEntitiesRoles_Call) Return(_a0 error) *Provisioner_RemoveEntitiesRoles_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *Provisioner_RemoveEntitiesRoles_Call) RunAndReturn(run func(context.Context, string, string, []string, []policies.Policy, []policies.Policy) error) *Provisioner_RemoveEntitiesRoles_Call {
	_c.Call.Return(run)
	return _c
}
