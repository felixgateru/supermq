...
type SDK interface {
	...
	//    Limit:  10,
	//  }
	//  clients, _ := sdk.ListUserClients("userID", pm, "domainID", "token")
	//  fmt.Println(clients)
	...
	//
	// example:
	//  roles, _ := sdk.ClientRoles("clientID", "domainID", "token")
	//  fmt.Println(roles)
	ClientRoles(id, domainID, token string) (RolesPage, errors.SDKError)
	...
	//
	// example:
	//  members, _ := sdk.ClientRoleMembers("clientID", "roleName", "domainID", "token")
	//  fmt.Println(members)
	ClientRoleMembers(id, roleName, domainID string, token string) ([]string, errors.SDKError)
	...
	//
	// example:
	//  actions, _ := sdk.AvailableClientRoleActions("clientID", "domainID", "token")
	//  fmt.Println(actions)
	AvailableClientRoleActions(id, domainID, token string) ([]string, errors.SDKError)
	...
	CreateChannels(channels []Client, domainID, token string) ([]Client, errors.SDKError)
	...
	//  fmt.Println(err)
	ConnectClient(channelID string, clientIDs, connTypes []string, domainID, token string) errors.SDKError
	...
	//  fmt.Println(err)
	DisconnectClient(channelID string, clientIDs, connTypes []string, domainID, token string) errors.SDKError
	...
	//  fmt.Println(role)
	CreateDomainRole(id, domainID string, rq RoleReq, token string) (Role, errors.SDKError)
	...
	//  fmt.Println(roles)
	DomainRoles(id, domainID, token string) (RolesPage, errors.SDKError)
	...
	//  fmt.Println(role)
	DomainRole(id, roleName, domainID, token string) (Role, errors.SDKError)
	...
	//  fmt.Println(role)
	UpdateDomainRole(id, roleName, newName, domainID string, token string) (Role, errors.SDKError)
	...
	//  fmt.Println(err)
	DeleteDomainRole(id, roleName, domainID, token string) errors.SDKError
	...
	//  fmt.Println(actions)
	AddDomainRoleActions(id, roleName, domainID string, actions []string, token string) ([]string, errors.SDKError)
	...
	//  fmt.Println(actions)
	DomainRoleActions(id, roleName, domainID string, token string) ([]string, errors.SDKError)
	...
	//  fmt.Println(err)
	RemoveDomainRoleActions(id, roleName, domainID string, actions []string, token string) errors.SDKError
	...
	//  fmt.Println(err)
	RemoveAllDomainRoleActions(id, roleName, domainID, token string) errors.SDKError
	...
	//  fmt.Println(members)
	AddDomainRoleMembers(id, roleName, domainID string, members []string, token string) ([]string, errors.SDKError)
	...
	//  fmt.Println(members)
	DomainRoleMembers(id, roleName, domainID string, token string) ([]string, errors.SDKError)
	...
	//  fmt.Println(err)
	RemoveDomainRoleMembers(id, roleName, domainID string, members []string, token string) errors.SDKError
	...
	//  fmt.Println(err)
	RemoveAllDomainRoleMembers(id, roleName, domainID, token string) errors.SDKError
	...
	//  fmt.Println(actions)
	AvailableDomainRoleActions(id, domainID, token string) ([]string, errors.SDKError)
