...
// TracingMiddleware returns a new channels service with tracing capabilities.
func TracingMiddleware(svc channels.Service, tracer trace.Tracer) channels.Service {
