...
type Service interface {
	...
	RetrieveByRoute(ctx context.Context, domainID, channelID string) (channels.Channel, error)
}
...
func (svc service) RetrieveByRoute(ctx context.Context, domainID, channelID string) (channels.Channel, error) {
	return svc.repo.RetrieveByRoute(ctx, domainID, channelID)
}
