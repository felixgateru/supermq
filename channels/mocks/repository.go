...
// RemoveDomainChannels provides a mock function for the type Repository
func (_mock *Repository) RemoveDomainChannels(ctx context.Context, domainID string) error {
	ret := _mock.Called(ctx, domainID)

	if len(ret) == 0 {
		panic("no return value specified for RemoveDomainChannels")
	}
...
// Repository_RemoveDomainChannels_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'RemoveDomainChannels'
type Repository_RemoveDomainChannels_Call struct {
	*mock.Call
}

// RemoveDomainChannels is a helper method to define mock.On call
//   - ctx context.Context
//   - domainID string
func (_e *Repository_Expecter) RemoveDomainChannels(ctx interface{}, domainID interface{}) *Repository_RemoveDomainChannels_Call {
	return &Repository_RemoveDomainChannels_Call{Call: _e.mock.On("RemoveDomainChannels", ctx, domainID)}
}

func (_c *Repository_RemoveDomainChannels_Call) Run(run func(ctx context.Context, domainID string)) *Repository_RemoveDomainChannels_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
...
func (_c *Repository_RemoveDomainChannels_Call) Return(err error) *Repository_RemoveDomainChannels_Call {
	_c.Call.Return(err)
	return _c
}

func (_c *Repository_RemoveDomainChannels_Call) RunAndReturn(run func(ctx context.Context, domainID string) error) *Repository_RemoveDomainChannels_Call {
	_c.Call.Return(run)
	return _c
}
