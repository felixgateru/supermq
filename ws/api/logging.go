...
func (lm *loggingMiddleware) Subscribe(ctx context.Context, clientKey, domainRoute, chanRoute, subtopic string, c *ws.Client) (err error) {
	...
	return lm.svc.Subscribe(ctx, clientKey, domainRoute, chanRoute, subtopic, c)
}
