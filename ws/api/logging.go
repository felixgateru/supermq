...
func (lm *loggingMiddleware) Subscribe(ctx context.Context, sessionID, username, password, domainID, chanID, subtopic string, c *ws.Client) (err error) {
	...
	return lm.svc.Subscribe(ctx, sessionID, username, password, domainID, chanID, subtopic, c)
}
