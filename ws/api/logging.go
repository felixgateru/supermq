...
func (lm *loggingMiddleware) Subscribe(ctx context.Context, sessionID, clientUsername, clientPassword, domainID, chanID, subtopic string, c *ws.Client) (err error) {
	...
	return lm.svc.Subscribe(ctx, sessionID, clientUsername, clientPassword, domainID, chanID, subtopic, c)
}
