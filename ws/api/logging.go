...
func (lm *loggingMiddleware) Subscribe(ctx context.Context, clientKey, domainID, chanRoute, subtopic string, c *ws.Client) (err error) {
	...
	return lm.svc.Subscribe(ctx, clientKey, domainID, chanRoute, subtopic, c)
}
