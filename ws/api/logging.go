...
func (lm *loggingMiddleware) Subscribe(ctx context.Context, clientKey, domainRoute, chanID, subtopic string, c *ws.Client) (err error) {
	...
	return lm.svc.Subscribe(ctx, clientKey, domainRoute, chanID, subtopic, c)
}
