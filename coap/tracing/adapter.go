...
func (tm *tracingServiceMiddleware) DisconnectHandler(ctx context.Context, domainID, chanRoute, subptopic, token string) error {
	...
	defer span.End()
	return tm.svc.DisconnectHandler(ctx, domainID, chanRoute, subptopic, token)
}
