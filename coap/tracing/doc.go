...
// Package tracing provides tracing instrumentation for SuperMQ CoAP adapter service.
//
// This package provides tracing middleware for SuperMQ CoAP adapter service.
// It can be used to trace incoming requests and add tracing capabilities to
// SuperMQ CoAP adapter service.
//
