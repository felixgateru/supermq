...
func (_c *Service_RetrieveById_Call) Return(_a0 groups.Group, _a1 error) *Service_RetrieveById_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *Service_RetrieveById_Call) RunAndReturn(run func(context.Context, string) (groups.Group, error)) *Service_RetrieveById_Call {
	_c.Call.Return(run)
	return _c
}
