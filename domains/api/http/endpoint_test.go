...
func TestSendInvitation(t *testing.T) {
	...
	cases := []struct {
	...
	}{
		{
			...
			token:       validToken,
			data:        fmt.Sprintf(`{"user_id": "%s","domain_id": "%s", "role_id": "%s"}`, validID, domainID, validID),
			status:      http.StatusCreated,
			contentType: contentType,
			svcErr:      nil,
		},
		{
			...
			token:       "",
			data:        fmt.Sprintf(`{"user_id": "%s","domain_id": "%s",  "role_id": "%s"}`, validID, validID, validID),
			status:      http.StatusUnauthorized,
			contentType: contentType,
			svcErr:      nil,
		},
		{
			...
			token:       validToken,
			data:        fmt.Sprintf(`{"user_id": "%s","domain_id": "%s",  "role_id": "%s"}`, validID, "", validID),
			status:      http.StatusBadRequest,
			contentType: contentType,
			svcErr:      nil,
		},
...
func TestListInvitation(t *testing.T) {
	...
	cases := []struct {
		...
		{
			desc:        "list invitations with user_id",
			token:       validToken,
		...
		{
			desc:        "list invitations with duplicate user_id",
			token:       validToken,
...
func TestViewInvitation(t *testing.T) {
	...
	cases := []struct {
		...
		{
			desc:        "view invitation with empty user_id",
			token:       validToken,
			userID:      "",
			domainID:    domainID,
			status:      http.StatusBadRequest,
		...
		{
			desc:        "view invitation with empty user_id and domain_id",
			token:       validToken,
			userID:      "",
			domainID:    "",
			status:      http.StatusNotFound,
...
func TestDeleteInvitation(t *testing.T) {
	...
	cases := []struct {
		...
		{
			desc:        "delete invitation with empty user_id",
			token:       validToken,
			userID:      "",
			domainID:    domainID,
			status:      http.StatusBadRequest,
		...
		{
			desc:        "delete invitation with empty user_id and domain_id",
			token:       validToken,
			userID:      "",
			domainID:    "",
			status:      http.StatusNotFound,
