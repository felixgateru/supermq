...
func (_mock *DomainsServiceClient) RetrieveByRoute(ctx context.Context, in *v1.RetrieveByRouteReq, opts ...grpc.CallOption) (*v10.RetrieveEntityRes, error) {
	var tmpRet mock.Arguments
	if len(opts) > 0 {
		tmpRet = _mock.Called(ctx, in, opts)
	} else {
	...
	var r1 error
	if returnFunc, ok := ret.Get(0).(func(context.Context, *v1.RetrieveByRouteReq, []grpc.CallOption) (*v10.RetrieveEntityRes, error)); ok {
		return returnFunc(ctx, in, opts)
	}
	if returnFunc, ok := ret.Get(0).(func(context.Context, *v1.RetrieveByRouteReq, ...grpc.CallOption) *v10.RetrieveEntityRes); ok {
		r0 = returnFunc(ctx, in, opts...)
	} else {
		if ret.Get(0) != nil {
	...
	if returnFunc, ok := ret.Get(1).(func(context.Context, *v1.RetrieveByRouteReq, ...grpc.CallOption) error); ok {
		r1 = returnFunc(ctx, in, opts...)
	} else {
		r1 = ret.Error(1)
	}
...
func (_c *DomainsServiceClient_RetrieveByRoute_Call) Run(run func(ctx context.Context, in *v1.RetrieveByRouteReq, opts ...grpc.CallOption)) *DomainsServiceClient_RetrieveByRoute_Call {
	_c.Call.Run(func(args mock.Arguments) {
		variadicArgs := make([]grpc.CallOption, len(args)-2)
		for i, a := range args[2:] {
			if a != nil {
		...
		run(args[0].(context.Context), args[1].(*v1.RetrieveByRouteReq), variadicArgs...)
	})
	return _c
}
...
func (_c *DomainsServiceClient_RetrieveByRoute_Call) RunAndReturn(run func(ctx context.Context, in *v1.RetrieveByRouteReq, opts ...grpc.CallOption) (*v10.RetrieveEntityRes, error)) *DomainsServiceClient_RetrieveByRoute_Call {
	_c.Call.Return(run)
	return _c
}
