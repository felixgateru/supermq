...
func (_c *CallBack_Authorize_Call) Return(_a0 error) *CallBack_Authorize_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *CallBack_Authorize_Call) RunAndReturn(run func(context.Context, policies.Policy) error) *CallBack_Authorize_Call {
	_c.Call.Return(run)
	return _c
}
