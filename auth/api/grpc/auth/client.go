...
func (client authGrpcClient) Authenticate(ctx context.Context, token *grpcAuthV1.AuthNReq, _ ...grpc.CallOption) (*grpcAuthV1.AuthNRes, error) {
	...
	return &grpcAuthV1.AuthNRes{Id: ir.id, UserId: ir.userID, UserRole: uint32(ir.userRole), DomainId: ir.domainID}, nil
}
...
func decodeIdentifyResponse(_ context.Context, grpcRes interface{}) (interface{}, error) {
	...
	return authenticateRes{id: res.GetId(), userID: res.GetUserId(), userRole: auth.Role(res.UserRole), domainID: res.GetDomainId()}, nil
}
