...
func (_m *Service) RetrieveById(ctx context.Context, id string) (things.Client, error) {
...
func (_m *Service) RetrieveByIds(ctx context.Context, ids []string) (things.ClientsPage, error) {
