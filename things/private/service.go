...
type Service interface {
	...
	RetrieveById(ctx context.Context, id string) (things.Client, error)

	RetrieveByIds(ctx context.Context, ids []string) (things.ClientsPage, error)
...
func (svc service) RetrieveById(ctx context.Context, ids string) (things.Client, error) {
	return svc.repo.RetrieveByID(ctx, ids)
}

func (svc service) RetrieveByIds(ctx context.Context, ids []string) (things.ClientsPage, error) {
