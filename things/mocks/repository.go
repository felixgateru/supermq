...
func (_m *Repository) RemoveParentGroup(ctx context.Context, th things.Client) error {
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, things.Client) error); ok {
		r0 = rf(ctx, th)
	} else {
		r0 = ret.Error(0)
	}
...
func (_m *Repository) RetrieveByIds(ctx context.Context, ids []string) (things.ClientsPage, error) {
	...
	var r0 things.ClientsPage
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, []string) (things.ClientsPage, error)); ok {
		return rf(ctx, ids)
	}
	if rf, ok := ret.Get(0).(func(context.Context, []string) things.ClientsPage); ok {
		r0 = rf(ctx, ids)
	} else {
		r0 = ret.Get(0).(things.ClientsPage)
	}
...
func (_m *Repository) RetrieveParentGroupThings(ctx context.Context, parentGroupID string) ([]things.Client, error) {
...
func (_m *Repository) SetParentGroup(ctx context.Context, th things.Client) error {
	ret := _m.Called(ctx, th)
