...
func (_m *Service) Authorize(ctx context.Context, req *magistrala.ThingsAuthReq) (string, error) {
	...
	var r0 string
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *magistrala.ThingsAuthReq) (string, error)); ok {
		return rf(ctx, req)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *magistrala.ThingsAuthReq) string); ok {
		r0 = rf(ctx, req)
	} else {
		r0 = ret.Get(0).(string)
	}

	if rf, ok := ret.Get(1).(func(context.Context, *magistrala.ThingsAuthReq) error); ok {
		r1 = rf(ctx, req)
	} else {
		r1 = ret.Error(1)
	}
