...
func (tm *tracingMiddleware) RegisterClient(ctx context.Context, authObject auth.AuthObject, client mgclients.Client, selfRegister bool) (mgclients.Client, error) {
	...
	return tm.svc.RegisterClient(ctx, authObject, client, selfRegister)
}

// IssueToken traces the "IssueToken" operation of the wrapped clients.Service.
func (tm *tracingMiddleware) IssueToken(ctx context.Context, identity, secret, domainID string) (auth.Token, error) {
...
func (tm *tracingMiddleware) RefreshToken(ctx context.Context, authObject auth.AuthObject, domainID string) (auth.Token, error) {
	ctx, span := tm.tracer.Start(ctx, "svc_refresh_token", trace.WithAttributes(attribute.String("access_token", authObject.Token)))
	defer span.End()

	return tm.svc.RefreshToken(ctx, authObject, domainID)
}

// ViewClient traces the "ViewClient" operation of the wrapped clients.Service.
func (tm *tracingMiddleware) ViewClient(ctx context.Context, authObject auth.AuthObject, id string) (mgclients.Client, error) {
	ctx, span := tm.tracer.Start(ctx, "svc_view_client", trace.WithAttributes(attribute.String("id", id)))
	defer span.End()

	return tm.svc.ViewClient(ctx, authObject, id)
}

// ListClients traces the "ListClients" operation of the wrapped clients.Service.
func (tm *tracingMiddleware) ListClients(ctx context.Context, authObject auth.AuthObject, pm mgclients.Page) (mgclients.ClientsPage, error) {
	...
	return tm.svc.ListClients(ctx, authObject, pm)
}

// SearchUsers traces the "SearchUsers" operation of the wrapped clients.Service.
func (tm *tracingMiddleware) SearchUsers(ctx context.Context, authObject auth.AuthObject, pm mgclients.Page) (mgclients.ClientsPage, error) {
	...
	return tm.svc.SearchUsers(ctx, authObject, pm)
}

// UpdateClient traces the "UpdateClient" operation of the wrapped clients.Service.
func (tm *tracingMiddleware) UpdateClient(ctx context.Context, authObject auth.AuthObject, cli mgclients.Client) (mgclients.Client, error) {
	...
	return tm.svc.UpdateClient(ctx, authObject, cli)
}

// UpdateClientTags traces the "UpdateClientTags" operation of the wrapped clients.Service.
func (tm *tracingMiddleware) UpdateClientTags(ctx context.Context, authObject auth.AuthObject, cli mgclients.Client) (mgclients.Client, error) {
	...
	return tm.svc.UpdateClientTags(ctx, authObject, cli)
}

// UpdateClientIdentity traces the "UpdateClientIdentity" operation of the wrapped clients.Service.
func (tm *tracingMiddleware) UpdateClientIdentity(ctx context.Context, authObject auth.AuthObject, id, identity string) (mgclients.Client, error) {
	...
	return tm.svc.UpdateClientIdentity(ctx, authObject, id, identity)
}

// UpdateClientSecret traces the "UpdateClientSecret" operation of the wrapped clients.Service.
func (tm *tracingMiddleware) UpdateClientSecret(ctx context.Context, authObject auth.AuthObject, oldSecret, newSecret string) (mgclients.Client, error) {
	ctx, span := tm.tracer.Start(ctx, "svc_update_client_secret")
	defer span.End()

	return tm.svc.UpdateClientSecret(ctx, authObject, oldSecret, newSecret)
}

// GenerateResetToken traces the "GenerateResetToken" operation of the wrapped clients.Service.
func (tm *tracingMiddleware) GenerateResetToken(ctx context.Context, email, host string) (auth.Token, error) {
...
func (tm *tracingMiddleware) ResetSecret(ctx context.Context, authObject auth.AuthObject, secret string) error {
	ctx, span := tm.tracer.Start(ctx, "svc_reset_secret")
	defer span.End()

	return tm.svc.ResetSecret(ctx, authObject, secret)
}
...
func (tm *tracingMiddleware) ViewProfile(ctx context.Context, authObject auth.AuthObject) (mgclients.Client, error) {
	ctx, span := tm.tracer.Start(ctx, "svc_view_profile")
	defer span.End()

	return tm.svc.ViewProfile(ctx, authObject)
}

// UpdateClientRole traces the "UpdateClientRole" operation of the wrapped clients.Service.
func (tm *tracingMiddleware) UpdateClientRole(ctx context.Context, authObject auth.AuthObject, cli mgclients.Client) (mgclients.Client, error) {
	...
	return tm.svc.UpdateClientRole(ctx, authObject, cli)
}

// EnableClient traces the "EnableClient" operation of the wrapped clients.Service.
func (tm *tracingMiddleware) EnableClient(ctx context.Context, authObject auth.AuthObject, id string) (mgclients.Client, error) {
	ctx, span := tm.tracer.Start(ctx, "svc_enable_client", trace.WithAttributes(attribute.String("id", id)))
	defer span.End()

	return tm.svc.EnableClient(ctx, authObject, id)
}

// DisableClient traces the "DisableClient" operation of the wrapped clients.Service.
func (tm *tracingMiddleware) DisableClient(ctx context.Context, authObject auth.AuthObject, id string) (mgclients.Client, error) {
	ctx, span := tm.tracer.Start(ctx, "svc_disable_client", trace.WithAttributes(attribute.String("id", id)))
	defer span.End()

	return tm.svc.DisableClient(ctx, authObject, id)
}

// ListMembers traces the "ListMembers" operation of the wrapped clients.Service.
func (tm *tracingMiddleware) ListMembers(ctx context.Context, authObject auth.AuthObject, objectKind, objectID string, pm mgclients.Page) (mgclients.MembersPage, error) {
	...
	return tm.svc.ListMembers(ctx, authObject, objectKind, objectID, pm)
}

// Identify traces the "Identify" operation of the wrapped clients.Service.
func (tm *tracingMiddleware) Identify(ctx context.Context, authObject auth.AuthObject) (string, error) {
	ctx, span := tm.tracer.Start(ctx, "svc_identify", trace.WithAttributes(attribute.String("token", authObject.Token)))
	defer span.End()
