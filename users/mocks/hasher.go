...
//   - _a0 string
//   - _a1 string
func (_e *Hasher_Expecter) Compare(_a0 interface{}, _a1 interface{}) *Hasher_Compare_Call {
	return &Hasher_Compare_Call{Call: _e.mock.On("Compare", _a0, _a1)}
}

func (_c *Hasher_Compare_Call) Run(run func(_a0 string, _a1 string)) *Hasher_Compare_Call {
