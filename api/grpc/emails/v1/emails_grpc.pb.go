...
const (
	EmailService_SendEmail_FullMethodName = "/emails.v1.EmailService/SendEmail"
)
...
type EmailServiceClient interface {
	SendEmail(ctx context.Context, in *EmailReq, opts ...grpc.CallOption) (*SendEmailRes, error)
}
...
func (c *emailServiceClient) SendEmail(ctx context.Context, in *EmailReq, opts ...grpc.CallOption) (*SendEmailRes, error) {
...
type EmailServiceServer interface {
	SendEmail(context.Context, *EmailReq) (*SendEmailRes, error)
...
func (UnimplementedEmailServiceServer) SendEmail(context.Context, *EmailReq) (*SendEmailRes, error) {
...
func _EmailService_SendEmail_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(EmailServiceServer).SendEmail(ctx, req.(*EmailReq))
	}
...
var EmailService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "emails/v1/emails.proto",
}
