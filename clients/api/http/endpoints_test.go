...
func TestCreateClient(t *testing.T) {
	...
	cases := []struct {
	...
	}{
		{
			...
			domainID:    domainID,
			token:       validToken,
			authnRes:    smqauthn.Session{Subject: domainID + "_" + validID, UserID: validID, DomainID: domainID},
...
func TestListClients(t *testing.T) {
	...
	cases := []struct {
	...
	}{
		{
			...
			domainID: domainID,
			token:    validToken,
			authnRes: smqauthn.Session{UserID: validID, DomainID: domainID, Subject: domainID + "_" + validID, SuperAdmin: false},
			status:   http.StatusOK,
			listClientsResponse: clients.ClientsPage{
				Page: clients.Page{
					Total: 1,
