...
func NewPolicyAgent(client *authzed.ClientWithExperimental, logger *slog.Logger) policy.PolicyAgent {
	return &policyAgent{
		client:           client,
...
func (pa *policyAgent) AddPolicies(ctx context.Context, prs []policy.PolicyReq) error {
...
func (pa *policyAgent) AddPolicy(ctx context.Context, pr policy.PolicyReq) error {
	precond, err := pa.addPolicyPreCondition(ctx, pr)
	if err != nil {
		return err
	}
...
func (pa *policyAgent) DeletePolicies(ctx context.Context, prs []policy.PolicyReq) error {
	updates := []*v1.RelationshipUpdate{}
	for _, pr := range prs {
		updates = append(updates, &v1.RelationshipUpdate{
...
func (pa *policyAgent) DeletePolicyFilter(ctx context.Context, pr policy.PolicyReq) error {
...
func (pa *policyAgent) RetrieveObjects(ctx context.Context, pr policy.PolicyReq, nextPageToken string, limit uint64) ([]policy.PolicyRes, string, error) {
...
func (pa *policyAgent) RetrieveAllObjects(ctx context.Context, pr policy.PolicyReq) ([]policy.PolicyRes, error) {
	resourceReq := &v1.LookupResourcesRequest{
		Consistency: &v1.Consistency{
			Requirement: &v1.Consistency_FullyConsistent{
				FullyConsistent: true,
...
func (pa *policyAgent) RetrieveAllObjectsCount(ctx context.Context, pr policy.PolicyReq) (uint64, error) {
	var count uint64
	nextPageToken := ""
	for {
...
func (pa *policyAgent) RetrieveSubjects(ctx context.Context, pr policy.PolicyReq, nextPageToken string, limit uint64) ([]policy.PolicyRes, string, error) {
...
func (pa *policyAgent) RetrieveAllSubjects(ctx context.Context, pr policy.PolicyReq) ([]policy.PolicyRes, error) {
...
func (pa *policyAgent) RetrieveAllSubjectsCount(ctx context.Context, pr policy.PolicyReq) (uint64, error) {
	var count uint64
	nextPageToken := ""
	for {
		relationTuples, npt, err := pa.RetrieveSubjects(ctx, pr, nextPageToken, defRetrieveAllLimit)
...
func (pa *policyAgent) RetrievePermissions(ctx context.Context, pr policy.PolicyReq, filterPermission []string) (policy.Permissions, error) {
...
func (pa *policyAgent) addPolicyPreCondition(ctx context.Context, pr policy.PolicyReq) ([]*v1.Precondition, error) {
...
func (pa *policyAgent) userGroupPreConditions(ctx context.Context, pr policy.PolicyReq) ([]*v1.Precondition, error) {
	var preconds []*v1.Precondition
	...
	isSuperAdmin := false
	if err := pa.checkPolicy(ctx, policy.PolicyReq{
		Subject:     pr.Subject,
		SubjectType: pr.SubjectType,
...
func (pa *policyAgent) userThingPreConditions(ctx context.Context, pr policy.PolicyReq) ([]*v1.Precondition, error) {
	var preconds []*v1.Precondition
...
func (pa *policyAgent) userDomainPreConditions(ctx context.Context, pr policy.PolicyReq) ([]*v1.Precondition, error) {
	var preconds []*v1.Precondition
...
func (pa *policyAgent) checkPolicy(ctx context.Context, pr policy.PolicyReq) error {
